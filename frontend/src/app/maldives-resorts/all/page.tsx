                  ...
                  <div key={i} className="bg-white rounded-[24px] overflow-hidden flex flex-col shadow-[0_12px_40px_rgba(4,29,60,0.03)] animate-pulse">
                    ...
                    <div className="p-5 flex flex-col gap-3 flex-1">
                      ...
                      <div className="flex gap-1">
                        {[...Array(5)].map((_, s) => (
                          <div key={s} className="h-3 w-3 rounded-sm bg-[#e8edf3]" />
                        ))}
                      </div>
                      {/* Title */}
                      ...
                      <div className="flex gap-2 mt-1">
                        <div className="h-6 w-20 rounded-full bg-[#e8edf3]" />
                              ...
                              <div className="flex items-center gap-[2px] sm:gap-[3px] shrink-0">
                                {[...Array(5)].map((_, i) => {
                                  ...
                                  return (
                                    <div
                                      key={i}
                                      className={`w-[10px] h-[10px] sm:w-[12px] sm:h-[12px] rounded-full border-[1.5px] border-[#00aa6c] ${isFull ? 'bg-[#00aa6c]' : 'bg-transparent'
                                        }`}
