    ...
    <>
      ...
      <div className="fixed bottom-8 left-6 lg:bottom-10 lg:left-10 z-50">
        <div className="relative flex items-center group">
          <div className="absolute left-full ml-3 px-3 py-1.5 bg-white text-[#041d3c] text-[12px] font-semibold rounded-[10px] shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible -translate-x-2 group-hover:translate-x-0 transition-all duration-300 pointer-events-none whitespace-nowrap border border-gray-100">
            WhatsApp Us
          </div>
          <a
